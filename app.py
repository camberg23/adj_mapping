...
# If no word is searched or cluster selected, the plot will not highlight any cluster
if highlight_cluster_id is None:
    highlight_cluster_id = -1  # Set to a non-existent cluster ID
...
# Set the highlight_cluster_id to the selected cluster if no word is searched
